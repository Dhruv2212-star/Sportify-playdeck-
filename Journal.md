...
-  **Time taken: 36 minutes** (including datasheet review)


![Schematic Design](https://github.com/user-attachments/assets/4eba0008-82d9-4884-ac36-f8b0de78a6c6)
**Lapse-** https://lapse.hackclub.com/timelapse/cNsDbuVQeTtv
...
# PCB routing| time taken- 25 Mins
...
https://lapse.hackclub.com/timelapse/HbNP6czxwbrO

# Case making with fusion| 1 hour 40 mins
https://lapse.hackclub.com/timelapse/3T7hJ20QbLii
...
## top case (failed attempt)
<img width="1366" height="768" alt="image" src="https://github.com/user-attachments/assets/600a97e5-bcc8-422a-8bab-f5c5176fae98" />

## started making the assembly file | Time- 1 hour 30 mins  
https://lapse.hackclub.com/timelapse/fa2zcxGxBGC8 (DUE TO SOME REASON, THE RECORDING DIDN'T START SO THE STARTING PART GOT CUT OUT)
<img width="1366" height="768" alt="image" src="https://github.com/user-attachments/assets/6c1108a9-94ae-49ac-a6cb-24d0a733152b" />  

**while make the assemble file i realised a small mistake in the PCB and the top case**
1. the pcb header was wrongly rotated
2. the top case had minor dimention errors


# improvements
## Schematic & PCB | time take- 15 mins
...
https://lapse.hackclub.com/timelapse/GK2uGSXP3GSe  
...
# Firmware | time- 3 hour 
## did research on funtions i needed and the coorect the libs i needed for that and also had learn the functions of the liberaries to write the code, there were still many errors and it took several tries & misfuntions but in the end the final 'code.py' file was ready 
